...
function simplifyDataForResolution(data, from, to, resolution) {
    return engine_1.simplifyLine(lib_1.sliceData(data, from, to), resolution);
}
exports.simplifyDataForResolution = simplifyDataForResolution;
function simplifyDataForChart(data, from, to, chartWidth) {
    return engine_1.simplifyLine(lib_1.sliceData(data, from, to), lib_1.computeResolutionFromWidth(chartWidth, from, to));
}
